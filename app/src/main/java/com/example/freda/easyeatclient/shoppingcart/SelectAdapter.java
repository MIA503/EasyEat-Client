...
public class SelectAdapter extends RecyclerView.Adapter<SelectAdapter.ViewHolder> {
    ...
    private SparseArray<DishesItem> dataList;
    private NumberFormat nf;
    private LayoutInflater mInflater;

    public SelectAdapter(ShoppingCartActivity activity, SparseArray<DishesItem> dataList) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.item_selected_dishes, parent, false);
        return new ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(ViewHolder holder, int position) {
        DishesItem item = dataList.valueAt(position);
