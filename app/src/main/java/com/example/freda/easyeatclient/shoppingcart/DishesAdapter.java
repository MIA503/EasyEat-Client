...
public class DishesAdapter extends BaseAdapter implements StickyListHeadersAdapter {

    private ArrayList<DishesItem> dataList;
    private ShoppingCartActivity mContext;
    private NumberFormat nf;
    private LayoutInflater mInflater;

    public DishesAdapter(ArrayList<DishesItem> dataList, ShoppingCartActivity mContext) {
    ...
    public View getHeaderView(int position, View convertView, ViewGroup parent) {
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_type_header_view, parent, false);
        }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            convertView = mInflater.inflate(R.layout.item_dish, parent, false);
            holder = new ItemViewHolder(convertView);
            convertView.setTag(holder);
        } else {
            holder = (ItemViewHolder) convertView.getTag();
        }
        DishesItem item = dataList.get(position);
    ...
    class ItemViewHolder implements View.OnClickListener {
        ...
        public void bindData(DishesItem item) {
            this.item = item;
